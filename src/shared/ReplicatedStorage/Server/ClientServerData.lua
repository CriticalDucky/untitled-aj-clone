...
local replicaPromise = ReplicaCollection.get("ServerData"):andThen(function(replica)
...
local serverInfoPromise = replicaPromise:andThen(function(serverDataValue)
	return ReplicaCollection.get("PrivateServerInfo"):andThen(function(replica)
		local privateServerId = replica.Data.privateServerId
