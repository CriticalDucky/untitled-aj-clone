...
type Furniture = Types.ItemFurniture
...
function Furniture.addFurniture(furniture: Furniture, player: Player)
    ...
    DataReplication.replicateAsync("SetFurniture", allFurniture, player)
