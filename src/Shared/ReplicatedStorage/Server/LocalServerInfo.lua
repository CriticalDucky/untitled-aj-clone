...
local PlaceConstants = require(configurationFolder:WaitForChild "PlaceConstants")
...
do
	...
	if PlaceConstants.homePlaceId == game.PlaceId then serverType = ServerTypeEnum.home end
